...
import { ShoppingCart, Truck, Package, FileText, BarChart3 } from 'lucide-react'
    ...
    <div className="overflow-y-auto h-full">
      ...
      <div className="px-4 -mt-4 space-y-4 pb-6">
        <div className="grid grid-cols-2 gap-3">
          <StatCard label="Orders Today" value={todayOrders.data?.length || 0} icon={<ShoppingCart size={20} />} color="blue"
            onClick={() => navigate('/orders')} />
          <StatCard label="Processing" value={processing.data?.length || 0} icon={<Package size={20} />} color="green"
          ...
          <StatCard label="Awaiting Waybill" value={awaitingWaybill.data?.length || 0} icon={<Truck size={20} />} color="amber"
